...
/*
 * Start or resume the DXCluster connection worker.
 *
...
/*
 * Disconnect from DXCluster and stop the worker thread.
 *
 * @return Nothing.
 */
...
/*
 * Send a spot command to the currently connected DXCluster server.
 *
 * @param spot_text Spot payload. Both "DX ..." and payload-only forms are
 *                  accepted.
 * @return 0 on success, or -1 when disconnected/invalid.
 */
